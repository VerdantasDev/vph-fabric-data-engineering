...
try:
    ...
    src_table_path = "Tables/br_m365_sharepoint_download_file_status_resume"
    tgt_table_path = 'Tables/br_m365_sharepoint_download_file_status_resume'
    ...
    merge_keys = [column for column in source_df.columns if column not in ['custom_tags', 'download_status', 'bronze_save_path']]
