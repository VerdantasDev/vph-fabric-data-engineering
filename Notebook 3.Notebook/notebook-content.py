...
df = spark.sql("SELECT * FROM VPC_Dev_Fablh_data.br_deltek_trans_EMPayroll LIMIT 1000")
display(df)
...
adp_api_cert = mssparkutils.credentials.getSecret('https://vpc-dev-keyvault.vault.azure.net/','adp-cert-pem')
